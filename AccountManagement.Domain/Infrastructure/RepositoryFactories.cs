...
//        /// </remarks>
//        private IDictionary<Type, Func<DbContext, object>> GetAccountFactories()
//        {
...
//        {
//            _repositoryFactories = GetAccountFactories();
//        }
//        /// <summary>
//        /// Used to remove allready existing context with newly added one
//        /// </summary>
//        /// <typeparam name="T">Repository interface to be replaced with new context implementation</typeparam>
//        /// <param name="dbContext">Db context to be injected to repository</param>
//        private void RebindContext<T>(DbContext dbContext)
//        {
//            _repositoryFactories.Remove(typeof(T));
//            _repositoryFactories.Add(typeof(T), d => new AccountsRepository(dbContext));
//        }
//        /// <summary>
